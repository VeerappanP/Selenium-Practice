...
public class BaseClassCucumber {
	...
	public BaseClassCucumber(WebDriver driver1) {
		this.driver = driver1;
	}
	...
	public static WebDriver browserLaunch(Browser browser) {
		   WebDriver driver = null;
		
		if (browser.equals(Browser.CHROME)) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\crick\\Documents\\java\\Chrome driver\\chromedriver.exe");
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\crick\\Documents\\java\\Chrome driver\\edgedriver.exe");
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\crick\\Documents\\java\\Chrome driver\\geckodriver.exe");
